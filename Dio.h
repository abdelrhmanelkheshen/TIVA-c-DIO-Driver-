...
#define TOTAL_NO_OF_PORTS              (5U)
#define TOTAL_NO_OF_PINS               (8U)
   
#define PORTA_PINS_NUMBER              (6U)
#define PORTB_PINS_NUMBER              (8U)
#define PORTC_PINS_NUMBER              (4U)
#define PORTD_PINS_NUMBER              (6U)
#define PORTE_PINS_NUMBER              (6U)
#define PORTF_PINS_NUMBER              (5U)   
   
#define PORTA_MISSING_PIN_1            (0U)
#define PORTA_MISSING_PIN_2            (1U)
   
#define PORTC_MISSING_PIN_1            (0U)
#define PORTC_MISSING_PIN_2            (1U)
#define PORTC_MISSING_PIN_3            (2U)
#define PORTC_MISSING_PIN_4            (3U)

#define PORTD_MISSING_PIN_1            (4U)
#define PORTD_MISSING_PIN_2            (5U)
   
#define PORTE_MISSING_PIN_1            (6U)
#define PORTE_MISSING_PIN_2            (7U)
   
#define PORTF_MISSING_PIN_1            (5U)
#define PORTF_MISSING_PIN_2            (6U)
#define PORTF_MISSING_PIN_3            (7U)
 ...
 * error code (Not exist in AUTOSAR 4.0.3 DIO SWS Document.
 */
#define DIO_E_FALSE_WRITE                   (uint8)0xF1
...
/* Function for DIO Read Group of joined channels API */
Dio_PortLevelType Dio_ReadChannelGroup( const Dio_ChannelGroupType* ChannelGroupIdPtr );

/* Function for DIO Write Group of joined channels API */
